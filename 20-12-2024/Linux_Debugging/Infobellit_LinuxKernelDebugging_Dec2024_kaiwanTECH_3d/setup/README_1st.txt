...
1. These programs are distributed in the hope that they will be useful,
...
4. A suggestion: copy (at least) the src/ (or whatever it's called) 
folder onto your Linux partition in order to try out the same.

5. For futher info/program code etc please look up the URLs provided in 
your courseware.
...
Please do visit us at https://kaiwantech.com .
- We provide technical training - both Corporate and open-to-the-public 
Workshops - on Linux technologies.
